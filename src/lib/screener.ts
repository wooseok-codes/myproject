...
// ─── 분석 대상 종목 풀 ────────────────────────────────────────────────────────
// 국내(KOSPI/KOSDAQ) + 미국(S&P500/NASDAQ 주요 종목)
export const STOCK_UNIVERSE = {

  // ── KOSPI 대형주 (시가총액 상위 + 섹터 분산) ──
  korea_large: [
    ...
    { symbol: '326030.KS', name: 'SK바이오팜',          sector: '바이오',     market: 'KOSPI' },
  ],

  // ── KOSPI 성장주 (배터리·게임·방산 등 테마) ──
  korea_growth: [
    { symbol: '247540.KS', name: '에코프로비엠',    sector: '배터리소재', market: 'KOSPI' },
    { symbol: '086520.KS', name: '에코프로',         sector: '배터리소재', market: 'KOSPI' },
    ...
    { symbol: '047810.KS', name: '한국항공우주',        sector: '방산·항공',  market: 'KOSPI' },
    { symbol: '012450.KS', name: '한화에어로스페이스',   sector: '방산·항공',  market: 'KOSPI' },
    { symbol: '000720.KS', name: '현대건설',            sector: '건설',       market: 'KOSPI' },
    { symbol: '010950.KS', name: 'S-Oil',              sector: '정유',       market: 'KOSPI' },
  ],

  // ── KOSDAQ 유망 성장주 ──
  korea_kosdaq: [
    { symbol: '196170.KQ', name: '알테오젠',         sector: '바이오',     market: 'KOSDAQ' },
    { symbol: '086040.KQ', name: '제이더블유홀딩스',  sector: '바이오',     market: 'KOSDAQ' },
    { symbol: '214450.KQ', name: '파마리서치',         sector: '의료기기',   market: 'KOSDAQ' },
    { symbol: '091990.KQ', name: '셀트리온헬스케어',   sector: '바이오',     market: 'KOSDAQ' },
    { symbol: '950130.KQ', name: '에코프로에이치엔',   sector: '배터리소재', market: 'KOSDAQ' },
    { symbol: '357780.KQ', name: '솔브레인',           sector: '반도체소재', market: 'KOSDAQ' },
    { symbol: '054040.KQ', name: '한국컴퓨터',         sector: 'IT서비스',   market: 'KOSDAQ' },
    { symbol: '058470.KQ', name: '리노공업',            sector: '반도체장비', market: 'KOSDAQ' },
    { symbol: '403870.KQ', name: 'HPSP',               sector: '반도체장비', market: 'KOSDAQ' },
    { symbol: '317870.KQ', name: '엔젤로보틱스',        sector: 'AI·로봇',    market: 'KOSDAQ' },
    { symbol: '263750.KQ', name: '펄어비스',             sector: '게임',       market: 'KOSDAQ' },
    { symbol: '376300.KQ', name: '디어유',               sector: '엔터·플랫폼', market: 'KOSDAQ' },
    { symbol: '039030.KQ', name: '이오테크닉스',          sector: '레이저장비', market: 'KOSDAQ' },
    { symbol: '066970.KQ', name: 'L&F',                  sector: '배터리소재', market: 'KOSDAQ' },
    { symbol: '179900.KQ', name: '유티아이',              sector: '전자부품',   market: 'KOSDAQ' },
  ],

  // ── 미국 대형주 (S&P500 시총 상위 + 섹터 분산) ──
  us_large: [
    { symbol: 'AAPL',  name: 'Apple',        sector: 'Tech',        market: 'NASDAQ' },
    { symbol: 'MSFT',  name: 'Microsoft',    sector: 'Tech',        market: 'NASDAQ' },
    { symbol: 'NVDA',  name: 'NVIDIA',       sector: '반도체',      market: 'NASDAQ' },
    { symbol: 'GOOGL', name: 'Alphabet',     sector: 'Tech',        market: 'NASDAQ' },
    { symbol: 'AMZN',  name: 'Amazon',       sector: '이커머스·클라우드', market: 'NASDAQ' },
    { symbol: 'META',  name: 'Meta',         sector: '소셜미디어',   market: 'NASDAQ' },
    { symbol: 'TSLA',  name: 'Tesla',        sector: 'EV',          market: 'NASDAQ' },
    { symbol: 'AMD',   name: 'AMD',          sector: '반도체',      market: 'NASDAQ' },
    { symbol: 'INTC',  name: 'Intel',        sector: '반도체',      market: 'NASDAQ' },
    { symbol: 'AVGO',  name: 'Broadcom',     sector: '반도체',      market: 'NASDAQ' },
    { symbol: 'NFLX',  name: 'Netflix',      sector: '스트리밍',    market: 'NASDAQ' },
    { symbol: 'COST',  name: 'Costco',       sector: '유통·리테일', market: 'NASDAQ' },
    { symbol: 'ADBE',  name: 'Adobe',        sector: 'SaaS',        market: 'NASDAQ' },
    { symbol: 'QCOM',  name: 'Qualcomm',     sector: '반도체',      market: 'NASDAQ' },
    { symbol: 'ORCL',  name: 'Oracle',       sector: 'DB·클라우드', market: 'NYSE'   },
    { symbol: 'JPM',   name: 'JPMorgan',     sector: '금융',        market: 'NYSE'   },
    { symbol: 'BAC',   name: 'BofA',         sector: '금융',        market: 'NYSE'   },
    { symbol: 'GS',    name: 'Goldman Sachs', sector: '투자은행',   market: 'NYSE'   },
    { symbol: 'JNJ',   name: 'J&J',          sector: '헬스케어',    market: 'NYSE'   },
    { symbol: 'UNH',   name: 'UnitedHealth',  sector: '헬스케어',   market: 'NYSE'   },
    { symbol: 'LLY',   name: 'Eli Lilly',    sector: '제약',        market: 'NYSE'   },
    { symbol: 'V',     name: 'Visa',         sector: '금융',        market: 'NYSE'   },
    { symbol: 'MA',    name: 'Mastercard',   sector: '금융',        market: 'NYSE'   },
    { symbol: 'WMT',   name: 'Walmart',      sector: '유통·리테일', market: 'NYSE'   },
    { symbol: 'HD',    name: 'Home Depot',   sector: '유통·리테일', market: 'NYSE'   },
    { symbol: 'XOM',   name: 'ExxonMobil',   sector: '에너지',      market: 'NYSE'   },
    { symbol: 'CVX',   name: 'Chevron',      sector: '에너지',      market: 'NYSE'   },
    { symbol: 'PLTR',  name: 'Palantir',     sector: 'AI·데이터',   market: 'NYSE'   },
    { symbol: 'CRM',   name: 'Salesforce',   sector: 'SaaS',        market: 'NYSE'   },
    { symbol: 'NOW',   name: 'ServiceNow',   sector: 'SaaS',        market: 'NYSE'   },
  ],
}
